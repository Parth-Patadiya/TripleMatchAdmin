  ...
  try {
    ...
    switch (activityType) {
      case 'signIn':
        updatedUserActivity = {
          ...user.userActivity,
          signIn: [...user.userActivity.signIn, { ...activityDetails, date: Date.now() }],
        };
        break;
      case 'signOut':
        updatedUserActivity = {
          ...user.userActivity,
          signOut: [...user.userActivity.signOut, { ...activityDetails, date: Date.now() }],
        };
        break;
      case 'playForFun':
        updatedUserActivity = {
