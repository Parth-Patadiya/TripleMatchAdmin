...
interface VoucherTableProps {
  load: boolean; // Accept 'load' prop
}
const VoucherTable: React.FC<VoucherTableProps> = ({ load }) => {
  ...
  useEffect(() => {
    fetchVoucher(currentPage);
  }, [currentPage, load]); // Re-fetch when page or itemsPerPage changes
